...
**Software Engineer in Test (SDET) | MSc in Artificial Intelligence** *Building resilient automation frameworks and intelligent software solutions.*

---

### 🚀 About Me
- 🎓 **Master of Science in AI** from Dublin City University.
- 💻 Former **Software Developer in Test at TCS**, where I optimized CI/CD pipelines and reduced manual testing by 60%.
- 🤖 Passionate about **Machine Learning**, **Test Infrastructure**, and **Adversarial Modeling**.
- 🏆 NVIDIA Certified in **Deep Learning for Computer Vision**.
